...
inline void vmul(Vector &c, const Vector& a, const Vector& b) {
	c.x = a.x*b.x;
	c.y = a.y*b.y;
	c.z = a.z*b.z;
}
...
inline void vdiv(Vector &c, const Vector& a, const Vector& b) {
	c.x = a.x/b.x;
	c.y = a.y/b.y;
	c.z = a.z/b.z;
}
...
inline bool vle(const Vector &a, const Vector &b) {
